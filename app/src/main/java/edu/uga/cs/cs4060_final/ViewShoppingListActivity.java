...
public class ViewShoppingListActivity extends AppCompatActivity
    ...
    public static final String DEBUG_TAG = "NewShoppingListActivity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerAdapter = new ShoppingItemRecyclerAdapter(shoppingItemList, ViewShoppingListActivity.this);
